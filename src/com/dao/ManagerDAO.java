...
public class ManagerDAO {
	...
	public SectionInfo getPSectionById(Integer id) {
		...
		try {
			...
			if (rs != null && rs.next()) {
				...
				//System.out.println("test==========="+rs.getString("sName"));
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < clist.size(); i++) {
			...
			/*try {
				//System.out.println(blank + clist.get(i).getSname());
				//System.out.println(blank + new String(clist.get(i).getSname().getBytes("gbk"), "gbk"));
