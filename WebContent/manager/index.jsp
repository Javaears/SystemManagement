...
<table width="100%" height="981"  border="0" align="center" cellpadding="0" cellspacing="0"  style="border:1px solid #000000 ">
  <tr>
    <td height="21" align="center" valign="middle" bgcolor="#C5DEF5" style="background-image:url(image/topbar.jpg); background-position-y:30%; border-bottom:1px solid #000000">重要热带病研究网站后台管理</td>
  </tr>
  <tr>
                ...
                <td><table width="100%"  border="0" cellspacing="0" cellpadding="0" class="tt">
                    ...
                    <tr id="managerTr">
                      <td id="sub1" align="left" valign="middle" style="display:block; background-image:url(image/top_level_bg.gif);">
                        <div><a href="managerSection.jsp" target="main">项目管理</a></div>
                        <div><a href="addSection.jsp" target="main">项目添加</a></div></td>
                    </tr>
                    <!---->
                    <tr id="managerTr">
